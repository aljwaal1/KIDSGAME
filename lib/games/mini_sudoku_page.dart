  ...
  Future<void> _put(int number) async {
    ...
    try {
      if (solution[selected] == number) {
        ...
        if (!values.contains(0) && !completed) {
          completed = true;
