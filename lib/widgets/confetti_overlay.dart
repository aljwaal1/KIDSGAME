...
/// Wraps [child] and exposes a [burst] method (via a GlobalKey of
/// [ConfettiOverlayState]) that plays a short, colorful confetti animation
/// on top of the content. Used to celebrate wins in the games.
